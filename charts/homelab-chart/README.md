...
| verticalPodAutoscaler.targetRef.apiVersion | string | `"apps/v1"` |  |
| verticalPodAutoscaler.targetRef.kind | string | `"Deployment"` |  |
| verticalPodAutoscaler.targetRef.name | string | `""` |  |
| verticalPodAutoscaler.updatePolicy.updateMode | string | `"Initial"` |  |
| verticalPodAutoscalers | list | `[]` |  |
